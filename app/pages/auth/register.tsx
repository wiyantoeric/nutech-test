...
const RegisterPage = () => {
    ...
    return (
        <main className="h-dvh w-dvw grid grid-cols-1 md:grid-cols-2">
            ...
            <section className="h-full w-full flex flex-col justify-center items-center">
                <div className="w-full max-w-md flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-8 items-center">
                        ...
                        <h1 className="text-xl w-1/2 font-semibold text-center">Masuk atau Buat Akun untuk Memulai</h1>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button type="submit" disabled={loading} className="w-full bg-[#f42619] text-white py-3 rounded-md hover:bg-red-700 transition duration-200 disabled:bg-gray-400">
            ...
            {/* Banner */}
            <section className="max-h-dvh hidden md:block">
                <img src="/assets/images/login-image.png" alt="Login Illustration" className="w-full h-full object-cover" />
            </section>
        </main>
    );
};
