...
import type { Service } from '~/src/features/app/services/serviceService';
import toast from 'react-hot-toast';
import { createTransaction } from '~/src/features/transaction/services/transactionService';
import { useNavigate } from 'react-router';
import Button from '~/src/components/Button';

const ServiceContainer = ({ service }: { service: Service }) => {
